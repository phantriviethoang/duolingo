...
class StoreTestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'parts.*.part_number' => ['required', 'integer', 'min:1', 'max:10'],
            'parts.*.duration' => ['required', 'integer', 'min:1', 'max:120'],
    ...
    public function messages(): array
    {
        return [
            ...
            'parts.*.part_number.max' => 'Số phần không được vượt quá 10.',
            ...
            'parts.*.duration.max' => 'Thời gian không được vượt quá 120 phút (2 giờ).',
