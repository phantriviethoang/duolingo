...
export default function AdminTests({ tests = [] }) {
    ...
    const handleDelete = (testId) => {
        ...
        router.delete(route("admin.tests.destroy", testId), {
            preserveScroll: true,
        });
    };
                                        ...
                                        <tr key={test.id} className="odd:bg-white even:bg-gray-50">
                                            ...
                                            <td className="px-4 py-3">
                                                <div className="flex gap-2">
                                                    <button className="rounded-full border border-gray-400 px-3 py-1 text-xs" disabled>
                                                        Sửa
                                                    </button>
                                                    <button
                                                        type="button"
                                                        onClick={() => handleDelete(test.id)}
                                                        className="rounded-full border border-gray-400 px-3 py-1 text-xs text-red-600"
                                                    >
                                                        Xóa
                                                    </button>
                                                </div>
